...
runner.registerScenario('EconomicResource composition / containment functionality', async (s, t) => {
  ...
  const cResp1 = await alice.call('economic_event', 'create_event', { event: inputEvent, new_inventoried_resource: inputResource })
  await s.consistency()
  ...
  const cResp2 = await alice.call('economic_event', 'create_event', { event: inputEvent2, new_inventoried_resource: inputResource2 })
  await s.consistency()
  ...
  const cResp3 = await alice.call('economic_event', 'create_event', { event: inputEvent3, new_inventoried_resource: inputResource3 })
  await s.consistency()
