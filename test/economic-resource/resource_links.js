...
test('EconomicResource composition / containment functionality', async (t) => {
  ...
  try {
    ...
    t.deepLooseEqual(readResource.contains && readResource.contains[1], resourceId2, 'container resource reference B OK')
    t.deepLooseEqual(readResource.contains && readResource.contains[0], resourceId3, 'container resource reference A OK')
