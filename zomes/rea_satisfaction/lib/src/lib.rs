/**
 * hREA satisfaction zome library API
 *
...
pub fn construct_response(address: &SatisfactionAddress, meta: &SignedActionHashed, e: &EntryData) -> RecordAPIResult<ResponseData> {
    Ok(ResponseData {
