/**
 * hREA proposed intents: maintains relationships between coordinated proposals and the individual intents that describe their planned enaction. zome internal data structures
 *
...
impl From<EntryStorage> for EntryDefinitions
{
    ...
    {
        EntryDefinitions::ProposedIntent(e)
    }
}
