/**
 * hREA process specification integrity zome for API definition
 *
 ...
 */
use hdi::prelude::*;
pub use hc_zome_rea_process_specification_storage::{EntryDefinitions, EntryTypesUnit, LinkTypes};
