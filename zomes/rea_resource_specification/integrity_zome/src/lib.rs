/**
 * hREA resource specification integrity zome for API definition
 *
 ...
 */
use hdi::prelude::*;
pub use hc_zome_rea_resource_specification_storage::{EntryDefinitions, EntryTypesUnit, LinkTypes};
