...
let ENV_CONNECTION_URI = (typeof process !== "undefined" ? process.env : {}).REACT_APP_HC_CONN_URL as string || ''
let ENV_HOLOCHAIN_APP_ID = (typeof process !== "undefined" ? process.env : {}).REACT_APP_HC_APP_ID as string || ''
