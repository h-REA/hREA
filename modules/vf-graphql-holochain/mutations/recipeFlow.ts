...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  const runCreate = mapZomeFn<CreateArgs, RecipeFlowResponse>(dnaConfig, conductorUri, 'combined', 'recipe_flow', 'create_recipe_flow')
  const runUpdate = mapZomeFn<UpdateArgs, RecipeFlowResponse>(dnaConfig, conductorUri, 'combined', 'recipe_flow', 'update_recipe_flow')
