...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  const runCreate = mapZomeFn<CreateArgs, IntentResponse>(dnaConfig, conductorUri, 'hrea_combined', 'intent', 'create_intent')
  const runUpdate = mapZomeFn<UpdateArgs, IntentResponse>(dnaConfig, conductorUri, 'hrea_combined', 'intent', 'update_intent')
  const runDelete = mapZomeFn<ByRevision, boolean>(dnaConfig, conductorUri, 'hrea_combined', 'intent', 'delete_intent')
