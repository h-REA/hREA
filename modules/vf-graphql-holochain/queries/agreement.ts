...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  const readRecord = mapZomeFn<ReadParams, AgreementResponse>(dnaConfig, conductorUri, 'hrea_combined', 'agreement', 'get_agreement')
  const readAll = mapZomeFn<PagingParams, AgreementConnection>(dnaConfig, conductorUri, 'hrea_combined', 'agreement_index', 'read_all_agreements')
