...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  const readOne = mapZomeFn<ReadParams, RecipeFlowResponse>(dnaConfig, conductorUri, 'combined', 'recipe_flow', 'get_recipe_flow')
  const readAll = mapZomeFn<PagingParams, RecipeFlowConnection>(dnaConfig, conductorUri, 'combined', 'indexing', 'read_all_recipe_flows')
