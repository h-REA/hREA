...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  const readOne = mapZomeFn<ReadParams, CommitmentResponse>(dnaConfig, conductorUri, 'hrea_combined', 'commitment', 'get_commitment')
  const readAll = mapZomeFn<PagingParams, CommitmentConnection>(dnaConfig, conductorUri, 'hrea_combined', 'commitment_index', 'read_all_commitments')
